...
public class MedicalStationDelete extends JFrame implements ActionListener {
	...
	public MedicalStationDelete(String title, int width, int height, MedicalStationAdmin medicalstationAdmin) {
		this.setTitle(title);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == btnDelete) {
			if(tf1.getText().equals("")) {
				...
				String sql = "DELETE FROM medicalstation WHERE medicalstationID = '" + tf1.getText() + "' ";
				deleteDB(sql);
