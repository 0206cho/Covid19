...
public class VaccinationstatusModify extends JFrame implements ActionListener {
   ...
   public VaccinationstatusModify(String title, int width, int height, VaccinationstatusAdmin comfirmedAdmin) {
      this.setTitle(title);
