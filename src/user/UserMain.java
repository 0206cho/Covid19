...
//			public void run() {
				try {
					...
					confirmed_elm = doc.select("#_cs_production_type > div > div.main_tab_area > div > div > ul > li.info_01 > em");
					death_elm = doc.select("#_cs_production_type > div > div.main_tab_area > div > div > ul > li.info_04 > em");
					totalCon_elm = doc.select("#_cs_production_type > div > div.main_tab_area > div > div > ul > li.info_01 > p");
					totalDea_elm = doc.select("#_cs_production_type > div > div.main_tab_area > div > div > ul > li.info_04 > p");
					...
					covid_label.setText("일일 확진자 :  " + today_confirmed + "  누적 확진자 :  " + today_totalCon + "  일일 사망자 :  " + today_death + "  ");
