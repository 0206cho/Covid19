...
public class IsolatedCheckList extends JFrame implements ActionListener {
   ...
   private JButton btnHeatYes, btnHeatNo, btnCoughYes, btnCoughNo, btnSTYes, btnSTNo, btnDyspneaYes, btnDyspneaNo, btnExit;
...
public void actionPerformed(ActionEvent e) {
	...
	if(obj == btnExit) {
		bt = tfBT.getText();  // 체온 값 가져오기   		
   		note = taNotee.getText();  // 특이사항 값 가져오기
