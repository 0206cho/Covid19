...
// JFrame을 불러옴
	public IsolatedMonitoring() {
		...
		lblMonitoring = new JLabel("<html><span style = 'font:bold 20px;'>◆자가모니터링 방법◆</span><br/><br/><br/>"
				+ "▶ 매일 아침, 저녁으로 체온 측정하기<br/><br/><br/>"
				+ "▶ 호흡기증상 등 감염 증상이 나타나는지 스스로 건강상태 확인<br/><br/><br/>"
				+ "▶ 보건소에서 1일 1회 이상 연락 시, 감염 증상 알려주기<br/><br/></html>");
		lblMonitoring.setFont(new Font("맑은고딕", Font.PLAIN, 14));
