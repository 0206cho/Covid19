...
public class Seoul_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Seoul_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Seoul_vaccinationstatus("서울 보건소 현황", 880, 615);
	}
