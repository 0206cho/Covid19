...
public class Incheon_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Incheon_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Incheon_vaccinationstatus("인천 보건소 현황", 880, 615);
	}
