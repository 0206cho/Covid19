...
public class Busan_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Busan_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Busan_vaccinationstatus("부산 보건소 현황", 880, 615);
	}
