package user.vaccinationstatus.gangwon;
...
public class Gangwon_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Gangwon_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Gangwon_vaccinationstatus("강원 보건소 현황", 880, 615);
	}
