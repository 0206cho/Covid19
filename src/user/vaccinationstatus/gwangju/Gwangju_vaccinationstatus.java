...
public class Gwangju_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Gwangju_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Gwangju_vaccinationstatus("광주 보건소 현황", 880, 615);
	}
