...
public class Sejong_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Sejong_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Sejong_vaccinationstatus("세종 보건소 현황", 880, 615);
	}
