...
public class Ulsan_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Ulsan_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Ulsan_vaccinationstatus("울산 보건소 현황", 880, 615);
	}
