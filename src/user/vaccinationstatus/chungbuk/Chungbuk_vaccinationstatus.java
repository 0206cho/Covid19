...
public class Chungbuk_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Chungbuk_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Chungbuk_vaccinationstatus("충북 보건소 현황", 880, 615);
	}
