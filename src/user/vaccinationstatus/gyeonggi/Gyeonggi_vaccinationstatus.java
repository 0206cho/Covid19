...
public class Gyeonggi_vaccinationstatus extends JFrame implements ActionListener {
	...
	public Gyeonggi_vaccinationstatus(String title, int width, int height) {
		this.setTitle(title);
...
//				+ "'";
	...
	public static void main(String[] args) {
		...
		new Gyeonggi_vaccinationstatus("경기 보건소 현황", 880, 615);
	}
