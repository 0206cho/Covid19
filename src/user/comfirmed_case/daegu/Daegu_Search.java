...
public class Daegu_Search extends JFrame implements ActionListener {
	...
	public Daegu_Search(String title, int width, int height, Daegu_Comfirmed daegu_Comfirmed) {
		...
		this.daegu_Comfirmed = daegu_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				daegu_Comfirmed.getSearch(daegu_Comfirmed.getModel(), getCombo, tx1.getText());
