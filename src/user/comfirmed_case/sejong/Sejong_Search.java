...
public class Sejong_Search extends JFrame implements ActionListener {
	...
	public Sejong_Search(String title, int width, int height, Sejong_Comfirmed chungnam_Comfirmed) {
		this.setTitle(title);
		...
		this.sejong_Comfirmed = sejong_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				sejong_Comfirmed.getSearch(sejong_Comfirmed.getModel(), getCombo, tx1.getText());
