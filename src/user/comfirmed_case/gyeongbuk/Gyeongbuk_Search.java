package user.comfirmed_case.gyeongbuk;
...
public class Gyeongbuk_Search extends JFrame implements ActionListener {
	...
	private JButton b2;
	private JLabel lb1;
	private  Gyeongbuk_Comfirmed gyeongbuk_Comfirmed;
	private JLabel lbl1;
	//JFrame을 상속 받아 만드는 방법 << 이걸 더 선호함.
	public Gyeongbuk_Search(String title, int width, int height, Gyeongbuk_Comfirmed gyeongbuk_Comfirmed) {
		this.setTitle(title);
		...
		this.gyeongbuk_Comfirmed = gyeongbuk_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				gyeongbuk_Comfirmed.getSearch(gyeongbuk_Comfirmed.getModel(), getCombo, tx1.getText());
