...
public class Ulsan_Search extends JFrame implements ActionListener {
	...
	public Ulsan_Search(String title, int width, int height, Ulsan_Comfirmed ulsan_Comfirmed) {
		this.setTitle(title);
		...
		this.ulsan_Comfirmed = ulsan_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				ulsan_Comfirmed.getSearch(ulsan_Comfirmed.getModel(), getCombo, tx1.getText());
