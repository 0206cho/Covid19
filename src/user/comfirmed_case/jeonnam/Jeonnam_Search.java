...
public class Jeonnam_Search extends JFrame implements ActionListener {
	...
	private JButton b2;
	private JLabel lb1;
	private  Jeonnam_Comfirmed jeonnam_Comfirmed;
	private JLabel lbl1;
	//JFrame을 상속 받아 만드는 방법 << 이걸 더 선호함.
	public Jeonnam_Search(String title, int width, int height, Jeonnam_Comfirmed jeonnam_Comfirmed) {
		this.setTitle(title);
		...
		this.jeonnam_Comfirmed = jeonnam_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				jeonnam_Comfirmed.getSearch(jeonnam_Comfirmed.getModel(), getCombo, tx1.getText());
