...
public class Gwangju_Search extends JFrame implements ActionListener {
	...
	private JButton b2;
	private JLabel lb1;
	private  Gwangju_Comfirmed gwangju_Comfirmed;
	private JLabel lbl1;
	//JFrame을 상속 받아 만드는 방법 << 이걸 더 선호함.
	public Gwangju_Search(String title, int width, int height, Gwangju_Comfirmed gwangju_Comfirmed) {
		this.setTitle(title);
		...
		this.gwangju_Comfirmed = gwangju_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				gwangju_Comfirmed.getSearch(gwangju_Comfirmed.getModel(), getCombo, tx1.getText());
