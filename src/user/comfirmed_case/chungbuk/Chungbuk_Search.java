package user.comfirmed_case.chungbuk;
...
public class Chungbuk_Search extends JFrame implements ActionListener {
	...
	public Chungbuk_Search(String title, int width, int height, Chungbuk_Comfirmed chungbuk_Comfirmed) {
		...
		this.chungbuk_Comfirmed = chungbuk_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				chungbuk_Comfirmed.getSearch(chungbuk_Comfirmed.getModel(), getCombo, tx1.getText());
