...
public class Gyeonggi_Search extends JFrame implements ActionListener {
	...
	private JButton b2;
	private JLabel lb1;
	private  Gyeonggi_Comfirmed gyeonggi_Comfirmed;
	private JLabel lbl1;
	//JFrame을 상속 받아 만드는 방법 << 이걸 더 선호함.
	public Gyeonggi_Search(String title, int width, int height, Gyeonggi_Comfirmed gyeonggi_Comfirmed) {
		this.setTitle(title);
		...
		this.gyeonggi_Comfirmed = gyeonggi_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				gyeonggi_Comfirmed.getSearch(gyeonggi_Comfirmed.getModel(), getCombo, tx1.getText());
