...
public class Jeju_Search extends JFrame implements ActionListener {
	...
	private JButton b2;
	private JLabel lb1;
	private  Jeju_Comfirmed jeju_Comfirmed;
	private JLabel lbl1;
	//JFrame을 상속 받아 만드는 방법 << 이걸 더 선호함.
	public Jeju_Search(String title, int width, int height, Jeju_Comfirmed jeju_Comfirmed) {
		this.setTitle(title);
		...
		this.jeju_Comfirmed = jeju_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				jeju_Comfirmed.getSearch(jeju_Comfirmed.getModel(), getCombo, tx1.getText());
