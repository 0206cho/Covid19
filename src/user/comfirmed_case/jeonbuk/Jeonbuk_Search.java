package user.comfirmed_case.jeonbuk;
...
public class Jeonbuk_Search extends JFrame implements ActionListener {
	...
	public Jeonbuk_Search(String title, int width, int height, Jeonbuk_Comfirmed jeonbuk_Comfirmed) {
		...
		this.jeonbuk_Comfirmed = jeonbuk_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				jeonbuk_Comfirmed.getSearch(jeonbuk_Comfirmed.getModel(), getCombo, tx1.getText());
