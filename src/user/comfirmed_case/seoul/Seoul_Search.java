...
public class Seoul_Search extends JFrame implements ActionListener {
	...
	public Seoul_Search(String title, int width, int height, Seoul_Comfirmed seoul_Comfirmed) {
		...
		this.seoul_Comfirmed = seoul_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				seoul_Comfirmed.getSearch(seoul_Comfirmed.getModel(), getCombo, tx1.getText());
			} catch (Exception e1) {
