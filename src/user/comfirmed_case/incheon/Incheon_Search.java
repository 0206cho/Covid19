...
public class Incheon_Search extends JFrame implements ActionListener {
	...
	public Incheon_Search(String title, int width, int height, Incheon_Comfirmed incheon_Comfirmed) {
		...
		this.incheon_Comfirmed = incheon_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				incheon_Comfirmed.getSearch(incheon_Comfirmed.getModel(), getCombo, tx1.getText());
