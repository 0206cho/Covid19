package user.comfirmed_case.gyeongnam;
...
public class Gyeongnam_Search extends JFrame implements ActionListener {
	...
	public Gyeongnam_Search(String title, int width, int height, Gyeongnam_Comfirmed gyeongnam_Comfirmed) {
		...
		this.gyeongnam_Comfirmed = gyeongnam_Comfirmed;
		p2 = new JPanel();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1) {
			...
			try {
				gyeongnam_Comfirmed.getSearch(gyeongnam_Comfirmed.getModel(), getCombo, tx1.getText());
