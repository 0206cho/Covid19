...
public class Daejeon_Search extends JFrame implements ActionListener {
	...
	public Daejeon_Search(String title, int width, int height, Daejeon_Comfirmed daejeon_Comfirmed) {
		this.setTitle(title);
		...
		this.daejeon_Comfirmed = daejeon_Comfirmed;
		p2 = new JPanel();
